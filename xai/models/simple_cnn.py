...
class CNNBinaryClassifier2D(CNNClassifier):
    def __init__(self) -> None:
        """CNN binary classifier model with 2-dimensional latent space"""
        super().__init__()
        self.conv1 = nn.Conv2d(1, 10, kernel_size=5)
        self.conv2 = nn.Conv2d(10, 20, kernel_size=5)
        self.conv2_drop = nn.Dropout2d()
        self.fc1 = nn.Linear(320, 50)
        self.fc2 = nn.Linear(50, 2)
        self.fc3 = nn.Linear(2, 2)  # Additional layer with 2 neurons here

    def model_category(self):
        return "CNNBinaryClassifier2D"
